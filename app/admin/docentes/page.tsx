'use client'
import CardFuncionariosAdmin from '@/app/components/funcionarios/CardFuncionariosAdmin';
...
export default function AddFuncionario() {
  ...
  return (
    ...
    <div className="flex flex-col w-full h-[auto] items-center justify-right">
