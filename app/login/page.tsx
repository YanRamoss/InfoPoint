export default function Login() {
    return(
        ...
        <form action="/admin" method="post" className="flex flex-col mx-auto w-[300px]">
            ...
            <input type="submit" value="Login" className="bg-iblue cursor-pointer w-[100px] rounded-[3px] text-white text-sm mx-auto" />
        </form>
        </>
    )
}