    ...
    <div className='flex flex-col h-[auto] gap-[30px]'>
      ...
      <div className="flex flex-col gap-[30px]">
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-black text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/imagemADM.jpg')] bg-cover bg-center items-center justify-center">
            Administração
          </div>
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-black text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/imagenedf.jpg')] bg-cover bg-center items-center justify-center">
            Edificações
          </div>
          <p className='text-[17px] w-[100%]'>
...
O Técnico em Edificações projeta e executa obras seguindo normas técnicas e legais, planeja e orça projetos, supervisiona construções, oferece assistência técnica em pesquisas e controle de materiais, coordena manutenções e orienta sobre produtos e equipamentos especializados na Construção Civil.</p>
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-blackblack text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/iamgensINFONET.jpg')] bg-cover bg-center items-center justify-center">
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-blackblack text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/imagenRH.jpg')] bg-cover bg-center items-center justify-center">
            Recursos Humanos
          </div>
          <p className='text-[17px] w-[100%]'>
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-blackblack text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/iamgemcomercio.jpg')] bg-cover bg-center items-center justify-center">
            Comercio
          </div>
          <p className='text-[17px] w-[100%]'>
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-blackblack text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/imagengestao.jpg')] bg-cover bg-center items-center justify-center">
            Gestão de Projetos
          </div>
          <p className='text-[17px] w-[100%]'>
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-blackblack text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/imagentrancacoes.jpg')] bg-cover bg-center items-center justify-center">
        ...
        <div className="flex flex-row gap-[40px]">
          <div className="flex text-blackblack text-[20px] font-bold w-[80%] h-[130px] bg-[url('/images/cursos/imagensecretariado.jpg')] bg-cover bg-center items-center justify-center">
            Secretariado
          </div>
          <p className='text-[17px] w-[100%]'>
